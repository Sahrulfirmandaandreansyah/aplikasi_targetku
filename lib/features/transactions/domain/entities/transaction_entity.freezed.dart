...
class _$TransactionEntityImpl implements _TransactionEntity {
  ...
  @override
  String toString() {
    return 'TransactionEntity(id: $id, targetId: $targetId, amount: $amount, type: $type, description: $description, date: $date)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, targetId, amount, type, description, date);
